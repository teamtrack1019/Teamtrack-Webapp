                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="mt-2 text-xs text-slate-600 space-y-1">
                        ...
                        <div>Tel: {(companySettings.phone && !companySettings.phone.includes('4690446')) ? companySettings.phone : '+49 172 6125371'} &bull; E-Mail: {companySettings.email || 'kontakt@team-track.de'}</div>
