...
export default function Navbar({ 
  ...
  return (
    <header className="h-16 w-full bg-white border-b border-slate-200 px-4 md:px-6 flex items-center justify-between shrink-0 z-20 shadow-sm">
      ...
      <div className="flex items-center space-x-2 md:space-x-3 flex-1 max-w-md">
        ...
        <div className="flex items-center w-full relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs md:text-sm focus:outline-none focus:ring-2 focus:ring-sky-500 focus:bg-white transition-all"
          />
        </div>
      </div>
      ...
      <div className="flex items-center space-x-2 md:space-x-3 ml-2">
        ...
        <div className="flex items-center space-x-1.5 md:space-x-2">
          <button
            ...
            className="flex items-center space-x-1.5 px-3 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl text-xs font-bold transition shadow-sm border border-slate-200 cursor-pointer"
          ...
          <button
            ...
            className="hidden sm:flex items-center space-x-1.5 px-3.5 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl text-xs font-bold transition shadow-sm border border-slate-200 cursor-pointer"
          ...
          <button
            ...
            className="flex items-center space-x-1.5 px-3.5 md:px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white rounded-xl text-xs font-bold transition shadow-md shadow-sky-600/20 cursor-pointer"
