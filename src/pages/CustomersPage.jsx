    ...
    <div className="p-4 sm:p-6 md:p-8 max-w-7xl mx-auto space-y-6 animate-fadeIn min-w-0">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-xs sm:text-sm mt-0.5">
            Alphabetische A-Z Übersicht, Lead-Quellen, monatliche Abos, Einmalleistungen & Nachfass-Status
          </p>
        </div>
        ...
        <div className="flex items-center gap-2.5 self-start sm:self-auto">
          ...
          <div className="hidden sm:flex items-center bg-slate-100 p-1 rounded-xl border border-slate-200">
            <button
              ...
              title="A-Z Listen- & Detailansicht"
      ...
      <div className="bg-white p-3.5 sm:p-4 rounded-2xl border border-slate-200 shadow-sm flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3">
        ...
        <div className="relative flex-1 max-w-md">
          ...
          <input
            type="text"
            placeholder="Firma, Name, E-Mail oder Lead-Quelle suchen..."
            value={searchTerm}
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          >
            Aktiv ({customers.filter(c => (Number(c.activeAbosCount || 0) > 0 || Number(c.einmaligeCount || 0) > 0 || Number(c.invoicesCount || 0) > 0 || c.status === 'active')).length})
          </button>
          <button
          ...
          >
            Interessenten ({customers.filter(c => !(Number(c.activeAbosCount || 0) > 0 || Number(c.einmaligeCount || 0) > 0 || Number(c.invoicesCount || 0) > 0 || c.status === 'active')).length})
          </button>
